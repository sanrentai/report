 ...
 */
@Stateless
public class TST0006BizLogicImpl extends BaseBizLogic implements TST0006BizLogic {

    private static final Logger LOG = Logger.getLogger(TST0006BizLogicImpl.class.getName());
    ...
    @Override
    public void loadTST0006ViewModel(TST0006ViewModel vm) {
    ...
    @Override
    public void chaXun(TST0006ViewModel vm) {
