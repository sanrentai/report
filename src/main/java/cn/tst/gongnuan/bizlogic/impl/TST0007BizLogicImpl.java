 ...
 */
@Stateless
public class TST0007BizLogicImpl extends BaseBizLogic implements TST0007BizLogic {

    private static final Logger LOG = Logger.getLogger(TST0007BizLogicImpl.class.getName());
    ...
    @Override
    public void loadTST0007ViewModel(TST0007ViewModel vm) {
    ...
    @Override
    public void chaXun(TST0007ViewModel vm) {
