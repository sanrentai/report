 ...
 */
@Entity
public class HySouFeiMingXiDTO implements Serializable {
    @Id
    private String id;
    //公司名
    private String name;
    ...
    public HySouFeiMingXiDTO() {
    }

    public HySouFeiMingXiDTO(String id, String name, BigDecimal area, BigDecimal yjk, BigDecimal jk, BigDecimal owe, BigDecimal sfl) {
        this.id = id;
        this.name = name;
        this.area = area;
        this.yjk = yjk;
