 ...
 */
@Entity
public class HySouFeiNianDuBiaoByBuildingDTO implements Serializable {
    @Id
    private String id;
    //公司名
...
//    private Date payDate;
    public HySouFeiNianDuBiaoByBuildingDTO() {
    }

    public HySouFeiNianDuBiaoByBuildingDTO(String id, String companyName, String buildingName, String yearNum, BigDecimal area, BigDecimal yjk, BigDecimal jk, BigDecimal owe, BigDecimal sfl, String sfy) {
        this.id = id;
